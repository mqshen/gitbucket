...
CREATE OR REPLACE VIEW `ISSUE_OUTLINE_VIEW` AS
 ...
 FROM ISSUE A, ISSUE_COMMENT B
   WHERE (A.USER_NAME = B.USER_NAME AND A.REPOSITORY_NAME = B.REPOSITORY_NAME AND A.ISSUE_ID = B.ISSUE_ID) AND B.`ACTION` IN ('comment', 'close_comment', 'reopen_comment')
